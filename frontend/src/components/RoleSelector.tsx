...
interface RoleSelectorProps {
  onRoleSelect: (role: 'admin' | 'student' | 'customer') => void;
}
      ...
      <div className="flex-grow w-full max-w-4xl mx-auto text-center flex flex-col items-center justify-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your intelligent knowledge hub. Choose your role to get started with a personalized experience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          {roles.map((role) => {
            ...
            return (
              <Card key={role.id} className="shadow-card hover:shadow-elevated transition-all duration-300 border-border/50">
                <CardContent className="p-6 text-center">
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${role.gradient} flex items-center justify-center`}>
